 ...
 * Search Section
 * 
 * slug: swimming-pool-service/search-page
 * title: Search Page
 * categories: swimming-pool-service
 */

return array(
    'title'      =>__( 'Search Page', 'swimming-pool-service' ),
...
<main id="primary" class="wp-block-group alignfull has-accent-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"></main>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-text-align-center">'. esc_html__(' No results found','swimming-pool-service') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">'. esc_html__('  We could not find any posts matching your search. Try different keywords.','swimming-pool-service') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"swimming-pool-service","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
